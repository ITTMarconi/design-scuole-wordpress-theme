...
*/
  ...
  $home_options->add_field(array(
    ...
    'name' => __('Velocità per il cambio di notizie', 'design_scuole_italia'),
  ...
  $home_options->add_field(array(
    'id' => $prefix . 'home_numero_rassegna',
    'name' => __('Numero di articoli in rassegna stampa', 'design_scuole_italia'),
    'desc' => __('Numero di articoli in rassegna stampa da mostrare', 'design_scuole_italia'),
    'type' => 'text_small',
    'default' => '5',
    'attributes' => array(
      'data-conditional-id' => $prefix . 'home_is_selezione_automatica',
  ...
  $home_options->add_field(array(
    ...
    'name' => __('Velocità per il cambio di articoli', 'design_scuole_italia'),
  ...
  $pulsanti_group_id = $home_options->add_field(array(
    'id'          =>  $prefix . 'pulsanti_group',
    'type'        => 'group',
    'repeatable'  => true,
    'options'     => array(
...
*/
  ...
  $presentazione_options->add_field(
    array(
      'name' => __('Selezione articoli ', 'design_scuole_italia'),
