...
?>
    <section class="section bg-petrol py-5 position-relative d-flex align-items-center overflow-hidden hero-argomenti" >
            ...
            <div class="row variable-gutters">
                <div class="col-md-5">
                    <div class="hero-title text-left">
                        <h1 class="p-0 mb-2 text-white"><?php _e("Argomenti", "design_scuole_italia"); ?></h1>
                        <h2 class="h4 font-weight-normal text-white"><?php echo $testo_argomenti; ?></h2>
                    </div><!-- /hero-title -->
                </div><!-- /col-md-5 -->
            </div><!-- /row -->
        </div><!-- /container -->
