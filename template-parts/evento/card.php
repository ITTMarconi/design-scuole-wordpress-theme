...
?>
<div class="card card-bg card-event bg-white card-thumb-rounded card-horizontal-thumb <?php echo $set_card_wrapper ? "card-wrapper" : ""; ?> <?php echo $in_corso ? "border border-success" : ""; ?>">
  <?php if ($image_url) { ?>
