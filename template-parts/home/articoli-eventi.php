          ...
          <div id="carouselIndicators-circ" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
              <?php foreach ($posts as $key => $post) { ?>
                <li data-target="#carouselIndicators-circ" data-slide-to="<?php echo $key; ?>" <?php echo $key === 0 ? 'class="active"' : ''; ?>></li>
              <?php } ?>
            </ol>

            <div class="carousel-inner">
              <?php foreach ($posts as $key => $post) { ?>
                <div class="carousel-item <?php echo $key === 0 ? 'active' : ''; ?>" data-interval="<?php echo $home_circolari_carousel_speed; ?>">
        ...
        ?>
              <div class="col-lg-<?php echo $lg; ?>">
                ...
                <div id="carouselIndicators-<?php echo $ct; ?>" class="carousel slide" data-ride="carousel">
                  <ol class="carousel-indicators">
                    <?php foreach ($posts as $key => $post) { ?>
                      <li data-target="#carouselIndicators-<?php echo $ct; ?>" data-slide-to="<?php echo $key; ?>" <?php echo $key === 0 ? 'class="active"' : ''; ?>></li>
                    <?php } ?>
                  </ol>

                  <div class="carousel-inner">
                    <?php foreach ($posts as $key => $post) { ?>
                      <div class="carousel-item <?php echo $key === 0 ? 'active' : ''; ?>" data-interval="<?php echo get_option_value($ct, 'speed'); ?>">
